...
//        request.setCoverURL("http://vod.aliyun.com/test_cover_url.jpg");
        ...
        // vod控制面板==>配置管理==>媒资管理配置==>分类管理==>音视频/图片分类ID
        request.setCateId(1000115308L);
        // vod控制面板==>配置管理==>媒资处理配置==>转码模板组
        request.setTemplateGroupId("176503d5f3ba53d04eb897e8798c77bd");
...
/*    public static void main(String[] argv) {
        ...
        //您的AccessKeySecret
        String accessKeySecret = "g7adHm1TwnUc5DlTwVJD2ev74q73Gd";
        //需要上传到VOD的本地视频文件的完整路径，需要包含文件扩展名
        String localFile = "E:\\business\\我的教程\\剪辑版\\01FPS之CS\\02静态地址动态地址.mp4";
        try {
            // 初始化VOD客户端并获取上传地址和凭证
            DefaultAcsClient vodClient = initVodClient(accessKeyId, accessKeySecret);
            String fileName = "02静态地址动态地址.mp4";
